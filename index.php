...
<body>
    <div class="calculator">
        <form method="post" action="process.php">
            <input type="text" class="calculator-screen" name="screen" value="<?php echo $_SESSION['screen'] ?? ''; ?>" disabled />
            <div class="calculator-keys">
                <button type="submit" name="key" value="C" class="operator">C</button>
                ...
                <button type="submit" name="key" value="00" class="zero">00</button>
                <button type="submit" name="key" value="." class="zero">.</button>
                <button type="submit" name="key" value="=" class="operator">=</button>
            </div>
        </form>
    </div>
